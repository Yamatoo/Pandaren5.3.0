...
enum EUnitFields
{
    ...
    UNIT_FIELD_BATTLEPETCOMPANIONGUID                = OBJECT_END + 0x000E, // Size: 2, Type: LONG, Flags: PUBLIC
    ...
    UNIT_FILED_SUMMONED_BY_HOME_REALM                = OBJECT_END + 0x0013, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_BYTES_0                               = OBJECT_END + 0x0014, // Size: 1, Type: BYTES, Flags: PUBLIC UNIT_FIELD_DISPLAY_POWER ?
    UNIT_OVERRIDE_DISPLAY_POWER_ID                   = OBJECT_END + 0x0015, // Size: 1, Type: Flags PUBLIC
    ...
    UNIT_FIELD_POWER2                                = OBJECT_END + 0x0018, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER3                                = OBJECT_END + 0x0019, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER4                                = OBJECT_END + 0x001A, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_POWER5                                = OBJECT_END + 0x001B, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_EFFECTIVE_LEVEL                       = OBJECT_END + 0x002D, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    UNIT_FIELD_BYTES_1                               = OBJECT_END + 0x0041, // Size: 1, Type: BYTES, Flags: PUBLIC  UNIT_FIELD_BYTES_1 ?/
    ...
    UNIT_MOD_CAST_SPEED                              = OBJECT_END + 0x0046, // Size: 1, Type: FLOAT, Flags: PUBLIC
    UNIT_MOD_CAST_HASTE                              = OBJECT_END + 0x0047, // Size: 1, Type: FLOAT, Flags: PUBLIC
    UNIT_MOD_HASTE                                   = OBJECT_END + 0x0048,
    UNIT_MOD_HASTE_REGEN                             = OBJECT_END + 0x0049,
    UNIT_CREATED_BY_SPELL                            = OBJECT_END + 0x004A, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_NPC_FLAGS                                   = OBJECT_END + 0x004B, // Size: 2, Type: INT, Flags: DYNAMIC
    ...
    UNIT_FIELD_RESISTANCES                           = OBJECT_END + 0x005D, // Size: 7, Type: INT, Flags: PRIVATE, OWNER, SPECIAL_INFO
    ...
    UNIT_FIELD_BYTES_2                               = OBJECT_END + 0x0074, // Size: 1, Type: BYTES, Flags: PUBLIC      UNIT_FIELD_SHAPESHIFT_FORM??
    UNIT_FIELD_ATTACK_POWER                          = OBJECT_END + 0x0075, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_ATTACK_POWER_MOD_POS                  = OBJECT_END + 0x0076, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_ATTACK_POWER_MOD_NEG                  = OBJECT_END + 0x0077, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_ATTACK_POWER_MULTIPLIER               = OBJECT_END + 0x0078, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_ATTACK_POWER                   = OBJECT_END + 0x0079, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_ATTACK_POWER_MOD_POS           = OBJECT_END + 0x007A, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_ATTACK_POWER_MOD_NEG           = OBJECT_END + 0x007B, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER        = OBJECT_END + 0x007C, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_MINRANGEDDAMAGE                       = OBJECT_END + 0x007D, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_MAXRANGEDDAMAGE                       = OBJECT_END + 0x007E, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POWER_COST_MODIFIER                   = OBJECT_END + 0x007F, // Size: 7, Type: INT, Flags: PRIVATE, OWNER
    UNIT_FIELD_POWER_COST_MULTIPLIER                 = OBJECT_END + 0x0086, // Size: 7, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_MAXHEALTHMODIFIER                     = OBJECT_END + 0x008D, // Size: 1, Type: FLOAT, Flags: PRIVATE, OWNER
    UNIT_FIELD_HOVERHEIGHT                           = OBJECT_END + 0x008E, // Size: 1, Type: FLOAT, Flags: PUBLIC    
    UNIT_FIELD_MIN_ITEM_LEVEL                        = OBJECT_END + 0x008F,
    UNIT_FIELD_MAXITEMLEVEL                          = OBJECT_END + 0x0090, // Size: 1, Type: INT, Flags: PUBLIC
    UNIT_FIELD_WILD_BATTLE_PET_LEVEL                 = OBJECT_END + 0x0091,
...
enum EUnitDynamicField
{
    ...
    UNIT_DYNAMIC_WORLD_EFFECTS                       = OBJECT_END + 0x0101,
    UNIT_DYNAMIC_END                                 = OBJECT_END + 0x0202
};
...
enum EPlayerFields
{
    ...
    PLAYER_REST_STATE_EXPERIENCE                     = UNIT_END + 0x0681, //it's PLAYER_REST_STATE_BONUS_POOL ??
    ...
    PLAYER_FIELD_BYTES                               = UNIT_END + 0x06A4, // Size: 1, Type: BYTES, Flags: PRIVATE PLAYER_FIELD_LIFETIME_MAX_RANK?
    ...
    PLAYER_NO_REAGENT_COST_1                         = UNIT_END + 0x06F8, // Size: 4, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_GLYPH_SLOTS_1                       = UNIT_END + 0x06FC, // Size: 6, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_GLYPHS_1                            = UNIT_END + 0x0702, // Size: 6, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_RESEARCHING_1                       = UNIT_END + 0x070A, // Size: 8, Type: TWO_SHORT, Flags: PRIVATE
    ...
    PLAYER_FIELD_LOOT_SPEC_ID                        = UNIT_END + 0x071D,
    PLAYER_FIELD_OVERRIDE_ZONE_PVP_TYPE              = UNIT_END + 0x071E,
    PLAYER_FIELD_ITEM_LEVEL_DELTA                    = UNIT_END + 0x071F,
